    ...
    async function loadDocx() {
      ...
      try {
        ...
        if (docContainerRef.current && arrayBuffer) {
          setLoadingStatus('Đang hiển thị chuẩn trang in Microsoft Word...');
    ...
    <div className="flex flex-col w-full h-full bg-slate-200/90 select-none overflow-hidden relative font-sans">
      ...
      <div className="h-12 bg-slate-900 border-b border-slate-700 px-3 md:px-5 flex items-center justify-between gap-2 shrink-0 z-30 shadow-md">
        ...
        <div className="flex items-center gap-2.5 overflow-hidden min-w-0">
          ...
          <span className="text-white text-xs md:text-sm font-bold truncate max-w-[200px] md:max-w-md">
            {documentTitle}
          </span>
          {lesson.fileSize && (
      ...
      >
        ...
        {!useFallback ? (
          ...
          /* FALLBACK: Authentic Word A4 Paper View (No weird boxes or dark cards) */
          <div
          ...
          >
            ...
            <div className="pb-6 mb-8 border-b border-slate-200 font-sans flex items-center justify-between">
              ...
              <span className="px-3 py-1 rounded-full bg-blue-50 text-blue-700 text-xs font-bold border border-blue-200 shrink-0">
                Microsoft Word
              </span>
            </div>
